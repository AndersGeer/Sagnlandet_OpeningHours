	...
	<form method="post">
    	<table class="op-form-table" id="op-holidays-form">
            ...
            <tr class="op-holiday">
                ...
                <td><input type="text" class="widefat start date-input" 	name="op-holiday-start[]" 	value="<?php echo $holiday->start ?>" onfocus="this.blur()" 	/></td>
                <td><input type="text" class="widefat end 	date-input" 	name="op-holiday-end[]" 	value="<?php echo $holiday->end ?>" onfocus="this.blur()"/></td>
